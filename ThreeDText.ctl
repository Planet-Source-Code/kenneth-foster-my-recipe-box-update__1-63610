...
Public Property Let ColorF(ByVal NewColorF As OLE_COLOR)
     m_ColorF = NewColorF
     PropertyChanged "ColorF"
     Doit Direction
End Property

Public Property Get ColorF() As OLE_COLOR
     ColorF = m_ColorF
End Property
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
     With PropBag
          ...
          ColorF = .ReadProperty("ColorF", m_def_ColorF)
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
     With PropBag
          ...
          Call .WriteProperty("ColorF", m_ColorF, m_def_ColorF)
...
Private Sub Doit(Index As Integer)
   ...
   For i = 0 To 254 Step Depth
      ...
      If i >= 250 Then UserControl.ForeColor = m_ColorF      'highlights start text
...
Private Sub ReSize()
     With Label1
      ...
      UserControl.Width = Label1.Width + (550 * Xoffset)
